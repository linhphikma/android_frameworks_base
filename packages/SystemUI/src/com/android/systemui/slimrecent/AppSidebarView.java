...
public class AppSidebarView extends FrameLayout {
    ...
    public AppSidebarView(Context context) {
        this(context, null);
    }

    public AppSidebarView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AppSidebarView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public static AppSidebarView mAppSidebarView;
    ...
    protected void onFinishInflate() {
        ...
        mSettingsObserver = new SettingsObserver(new Handler());
 		// BlurOS Project        
            mAppSidebarView = this;

            // inicia o BlurUtils
            mBlurUtils = new BlurUtils(mAppSidebarView.getContext());
            ...
            // cria o mBlurredView
            mBlurredView = new FrameLayout(mAppSidebarView.getContext());

            // insere o mBlurredView no mNotificationPanelView na posição 0 (ordem importa)
            mAppSidebarView.addView(mBlurredView, 0, new FrameLayout.LayoutParams(
                    FrameLayout.LayoutParams.MATCH_PARENT, FrameLayout.LayoutParams.MATCH_PARENT));
            mAppSidebarView.requestLayout();
    ...
    public static class BlurTask extends AsyncTask<Void, Void, Bitmap> {
        ...
        protected void onPreExecute() {
            ...
            Context context = mAppSidebarView.getContext();
